...
<html lang="en">
  <head>
    ...
    <title>User Accounts | DTR System</title>
      ...
      <div class="container-fluid">
        <div class="navbar-collapse collapse">
		  <ul class="nav navbar-nav">
			...
			<li class="active"><a href="accounts.php">User Accounts</a></li>
		...
		<div class="row">
				...
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">				  
					<ul class="nav nav-pills nav-stacked">
					  <li><a href="javascript: addAccount();"><span class="glyphicon glyphicon-plus"></span> Add User Account</a></li>
					  <li><a href="javascript: editAccount();"><span class="glyphicon glyphicon-pencil"></span> Edit User Account</a></li>
					  <li><a href="javascript: delAccount();"><span class="glyphicon glyphicon-minus"></span> Delete User Acount</a></li>
					</ul>
					<div class="form-group">
						<div class="checkbox">
							<label>
								<input id="ua-deleted" type="checkbox"> Show deleted accounts
							</label>
						</div>
					</div>
					<div id="account-filter" class="input-group">
						<input id="faccountname" type="text" class="form-control" placeholder="Last Name, First Name">
			...
			<div class="col-lg-9">
				<div class="panel panel-default">
				  ...
				  <div id="accounts-page" class="panel-body"></div>
				</div>			
			</div>
		</div>
	</div>	
