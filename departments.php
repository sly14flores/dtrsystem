...
<html lang="en">
  <head>
    ...
    <title>Departments | DTR System</title>
		...
		<div class="row">
				...
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">				  
					<ul class="nav nav-pills nav-stacked">
					  <li><a href="javascript: addDept();"><span class="glyphicon glyphicon-plus"></span> Add Department</a></li>
					  <li><a href="javascript: editDept();"><span class="glyphicon glyphicon-pencil"></span> Edit Department</a></li>
					  <li><a href="javascript: delDept();"><span class="glyphicon glyphicon-minus"></span> Delete Department</a></li>
					</ul>
					<div id="dept-filter" class="form-group">
						<input type="text" class="form-control" id="fdeptname" placeholder="Search department..." style="width: 250px;">						
					</div>
			...
			<div class="col-lg-9">
				<div class="panel panel-default">
				  ...
				  <div id="departments-page" class="panel-body"></div>
				</div>			
			</div>
		</div>
